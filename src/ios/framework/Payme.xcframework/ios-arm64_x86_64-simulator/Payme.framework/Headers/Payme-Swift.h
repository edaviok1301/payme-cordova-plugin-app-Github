...
@protocol PaymeClientDelegate;
enum PaymeEnviroment : NSInteger;
@class UIViewController;
@class PaymeRequest;

SWIFT_CLASS("_TtC5Payme11PaymeClient")
@interface PaymeClient : NSObject
- (nonnull instancetype)initWithDelegate:(id <PaymeClientDelegate> _Nonnull)delegate key:(NSString * _Nonnull)key OBJC_DESIGNATED_INITIALIZER;
- (void)setEnvironmentWithEnvironment:(enum PaymeEnviroment)environment;
- (void)authorizeTransactionWithController:(UIViewController * _Nonnull)controller usePresent:(BOOL)usePresent paymeRequest:(PaymeRequest * _Nonnull)paymeRequest;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

enum PaymeInternalAction : NSInteger;
@class PaymeResponse;

SWIFT_PROTOCOL("_TtP5Payme19PaymeClientDelegate_")
@protocol PaymeClientDelegate
...
SWIFT_CLASS("_TtC5Payme17PaymeCurrencyData")
@interface PaymeCurrencyData : NSObject
- (nonnull instancetype)initWithCode:(NSString * _Nonnull)code symbol:(NSString * _Nonnull)symbol OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, PaymeEnviroment, open) {
  PaymeEnviromentDevelopment = 0,
  PaymeEnviromentProduction = 1,
};

@class PaymeWalletData;
@class PaymeInstallmentsData;

SWIFT_CLASS("_TtC5Payme16PaymeFeatureData")
@interface PaymeFeatureData : NSObject
- (nonnull instancetype)initWithReserved:(NSDictionary<NSString *, NSString *> * _Nullable)reserved wallet:(PaymeWalletData * _Nullable)wallet installments:(PaymeInstallmentsData * _Nullable)installments authentication:(PaymeAuthenticationData * _Nullable)authentication OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC5Payme21PaymeInstallmentsData")
@interface PaymeInstallmentsData : NSObject
- (nonnull instancetype)initWithEnable:(BOOL)enable OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, PaymeInternalAction, open) {
  PaymeInternalActionPRESS_PAY_BUTTON = 0,
  PaymeInternalActionSTART_SCORING = 1,
  PaymeInternalActionEND_SCORING = 2,
  PaymeInternalActionSTART_TDS = 3,
  PaymeInternalActionEND_TDS = 4,
  PaymeInternalActionSTART_AUTHORIZATION = 5,
};

@class PaymeOperationData;
@class PaymePersonData;

SWIFT_CLASS("_TtC5Payme17PaymeMerchantData")
@interface PaymeMerchantData : NSObject
- (nonnull instancetype)initWithOperation:(PaymeOperationData * _Nonnull)operation addrMatch:(BOOL)addrMatch billing:(PaymePersonData * _Nonnull)billing shipping:(PaymePersonData * _Nullable)shipping OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC5Payme18PaymeOperationData")
@interface PaymeOperationData : NSObject
- (nonnull instancetype)initWithOperationNumber:(NSString * _Nonnull)operationNumber operationDescription:(NSString * _Nonnull)operationDescription amount:(NSString * _Nonnull)amount currency:(PaymeCurrencyData * _Nonnull)currency OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class PaymeSettingData;

SWIFT_CLASS("_TtC5Payme12PaymeRequest")
@interface PaymeRequest : NSObject
- (nonnull instancetype)initWithMerchant:(PaymeMerchantData * _Nonnull)merchant feature:(PaymeFeatureData * _Nullable)feature setting:(PaymeSettingData * _Nonnull)setting OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC5Payme13PaymeResponse")
@interface PaymeResponse : NSObject
...
@property (nonatomic, readonly, copy) NSString * _Nullable resultDetail;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nullable reserved;
@property (nonatomic, readonly, strong) PaymentProcessResponse * _Nullable payment;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC5Payme16PaymeSettingData")
@interface PaymeSettingData : NSObject
- (nonnull instancetype)initWithLocale:(NSString * _Nonnull)locale brands:(NSArray<NSString *> * _Nonnull)brands OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC5Payme15PaymeWalletData")
@interface PaymeWalletData : NSObject
- (nonnull instancetype)initWithEnable:(BOOL)enable userID:(NSString * _Nullable)userID OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, copy) NSString * _Nullable firstExpirationDate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC5Payme22PaymentProcessResponse")
@interface PaymentProcessResponse : NSObject
@property (nonatomic, readonly) BOOL accepted;
@property (nonatomic, readonly, copy) NSString * _Nullable operationNumber;
@property (nonatomic, readonly, copy) NSString * _Nullable operationDate;
@property (nonatomic, readonly, copy) NSString * _Nullable authorizationCode;
@property (nonatomic, readonly, copy) NSString * _Nullable maskedPan;
@property (nonatomic, readonly, copy) NSString * _Nullable brand;
@property (nonatomic, readonly, strong) PaymentIntallmentsResponse * _Nullable installment;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
