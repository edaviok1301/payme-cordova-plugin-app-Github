...
SWIFT_CLASS("_TtC5Payme27PagerTabStripViewController")
...
SWIFT_CLASS("_TtC5Payme30BarPagerTabStripViewController")
...
SWIFT_CLASS("_TtC5Payme7BarView")
...
SWIFT_CLASS("_TtC5Payme36ButtonBarPagerTabStripViewController")
...
SWIFT_CLASS("_TtC5Payme13ButtonBarView")
...
SWIFT_CLASS("_TtC5Payme17ButtonBarViewCell")
...
- (nonnull instancetype)initWithData:(ModelMerchantData * _Nonnull)data settings:(ModelMerchantSettings * _Nonnull)settings features:(ModelMerchantFeatures * _Nonnull)features OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithOperation:(ModelMerchantDataOperation * _Nonnull)operation shipping:(ModelMerchantDataPerson * _Nullable)shipping billing:(ModelMerchantDataPerson * _Nullable)billing customer:(ModelMerchantDataPerson * _Nullable)customer signature:(NSString * _Nonnull)signature OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithWallet:(ModelMerchantFeaturesWallet * _Nonnull)wallet reserved:(NSArray<ModelMerchantFeaturesReserved *> * _Nonnull)reserved planQuota:(BOOL)planQuota OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC5Payme36SegmentedPagerTabStripViewController")
...
SWIFT_CLASS("_TtC5Payme34TwitterPagerTabStripViewController")
